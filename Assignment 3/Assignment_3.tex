...
\begin{verbatim}
##                mu       sigma
## mu    1.000000000 0.002073111
## sigma 0.002073111 1.000000000
\end{verbatim}
\begin{alltt}
...
\hlkwd{ggplot}\hlstd{(}\hlkwc{data} \hlstd{= d2,}\hlkwc{mapping} \hlstd{=} \hlkwd{aes}\hlstd{(}\hlkwc{x} \hlstd{= weight,}\hlkwc{y} \hlstd{= height))} \hlopt{+}
  ...
  \hlkwd{geom_abline}\hlstd{(}\hlkwc{color} \hlstd{=} \hlstr{"blue"}\hlstd{,} \hlkwc{slope} \hlstd{= lm.1}\hlopt{$}\hlstd{coefficients[}\hlnum{2}\hlstd{],}
              \hlkwc{intercept} \hlstd{= lm.1}\hlopt{$}\hlstd{coefficients,} \hlkwc{size} \hlstd{=} \hlnum{1.5}\hlstd{,}
              \hlkwc{show.legend} \hlstd{=} \hlnum{TRUE}\hlstd{)} \hlopt{+}
  \hlkwd{geom_abline}\hlstd{(}\hlkwc{color} \hlstd{=} \hlstr{"red"}\hlstd{,} \hlkwc{slope} \hlstd{=} \hlkwd{coef}\hlstd{(m4.3)[}\hlstr{"b"}\hlstd{],}
              \hlkwc{intercept} \hlstd{=} \hlkwd{coef}\hlstd{(m4.3)[}\hlstr{"a"}\hlstd{],} \hlkwc{size} \hlstd{=} \hlnum{1.5}\hlstd{,}
              \hlkwc{show.legend} \hlstd{=} \hlnum{TRUE}\hlstd{)} \hlopt{+}
  \hlkwd{ggtitle}\hlstd{(}\hlstr{"Frquentist Model (Blue) vs. Bayesian Model (Red)"}\hlstd{)} \hlopt{+} \hlstd{theme.info}
\end{alltt}
\end{kframe}
...
## a     113.88343 1.91555 110.21521 117.64612
## b       0.90489 0.04213   0.82236   0.98618
## sigma   5.07235 0.19136   4.71182   5.45869
\end{verbatim}
\end{kframe}
\end{knitrout}
